...
import { BookOpen, Book, BookMarked, Video } from 'lucide-react';

const IlmTab = () => {
  const items = [
    { title: 'Quran Explorer', icon: BookOpen, desc: 'Full 114 Surahs' },
    { title: 'Hadith Explorer', icon: Book, desc: 'Sihah Sittah' },
    { title: 'Kitab', icon: BookMarked, desc: 'Books & Articles' },
    { title: 'Boyan', icon: Video, desc: 'Lectures' },
  ];

  return (
    <div className="p-4 pb-24">
      <h2 className="text-xl font-bold mb-4">Ilm (Knowledge)</h2>
