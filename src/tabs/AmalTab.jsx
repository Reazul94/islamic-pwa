...
import { CheckCircle2, Moon, HandMetal, Navigation } from 'lucide-react';

const AmalTab = () => {
  const items = [
    { title: 'Daily Salat Tracker', icon: CheckCircle2, desc: 'Track your prayers' },
    { title: 'Tasbih', icon: HandMetal, desc: 'Digital Counter' },
    { title: 'Hisnul Muslim', icon: Moon, desc: 'Daily Duas' },
    { title: 'Hajj & Umrah', icon: Navigation, desc: 'Step-by-step guide' },
  ];

  return (
    <div className="p-4 pb-24">
      <h2 className="text-xl font-bold mb-4">Amal (Actions)</h2>
